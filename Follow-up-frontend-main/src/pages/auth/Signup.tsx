...
import { signupFormSchema, type SignupFormValues } from '@/schema/auth/signup.schema'
...
export default function Signup() {
  ...
  const onSignupSubmit = async (values: SignupFormValues) => {
    ...
    try {
      ...
      showError((error as { data?: { message?: string } })?.data?.message || 'Registration failed. Please try again.')
    }
      ...
      <Card className='w-full max-w-[28rem] rounded-2xl border-slate-200 bg-white py-8 shadow-sm'>
        <CardContent className='px-8'>
          ...
          <div className='mb-8 space-y-2 text-center'>
            <h1 className='text-4xl font-semibold tracking-tight text-slate-900'>Create your account</h1>
            <p className='text-lg text-slate-600'>
              Start transforming your call transcripts into AI-powered follow-ups
            </p>
          </div>
