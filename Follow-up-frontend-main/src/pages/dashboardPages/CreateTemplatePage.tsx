...
import { useCreatePromptTemplateMutation } from "@/store/features/templates/templatesApi";
...
export default function CreateTemplatePage() {
  ...
  const [createPromptTemplate, { isLoading }] = useCreatePromptTemplateMutation();
  ...
  const onSubmit = async (values: CreatePromptTemplateFormValues) => {
    const loadingToastId = showLoading("Creating prompt template...");
    ...
    try {
      ...
      showSuccess(response.message || "Prompt template created successfully");
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-4xl font-semibold text-slate-900">Create Prompt Template</h2>
